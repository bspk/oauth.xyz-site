...
Other mechanisms in OpenID Connect become unnecessary additions, including the request object and hybrid signed response modes. Many of these components were invtend to overcome shortcomings in the OAuth 2 protocol that XYZ does not share. 
