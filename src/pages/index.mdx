...
After successful authorization, the client will continue a transaction with the authorization server. This can result in additional responses to continue the transaction, as needed.
