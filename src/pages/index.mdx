...
GNAP has several core features that drive its design principles, and these are key to providing a consistent data model:
 ...
 - Intent registration. This allows the client to start the process off the same way every time by making a <Link to="/transactionrequest/">request to the authorization server</Link>.
...
This website is the most comprehensive and complete collections of information about the XYZ project and GNAP.
